...
export const settingsDict = {
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterial': 'Materiał okna',
  'settings.openchamber.desktopNetwork.field.windowMaterialDescription': 'Pozwala tapecie pulpitu Windows prześwitywać przez główne okno. Mica jest subtelna, Acrylic rozmywa mocniej. Tylko Windows.',
  'settings.openchamber.desktopNetwork.field.windowMaterialAria': 'Materiał okna',
  'settings.openchamber.desktopNetwork.option.windowMaterialOff': 'Wyłączony',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacity': 'Krycie tła',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription': 'Jak kryjące pozostaje tło aplikacji nad tapetą pulpitu. Niższa wartość przepuszcza więcej.',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria': 'Krycie tła',
  ...
  'settings.openchamber.visual.field.widgetCorners': 'Kształt widżetów',
  'settings.openchamber.visual.field.widgetCornersHint': 'Zaokrąglony zachowuje obecny wygląd. Kanciasty usuwa wszystkie zaokrąglenia.',
  'settings.openchamber.visual.field.widgetCornersAria': 'Wybierz kształt widżetów',
  'settings.openchamber.visual.option.widgetCorners.round': 'Zaokrąglony',
  'settings.openchamber.visual.option.widgetCorners.square': 'Kanciasty',
