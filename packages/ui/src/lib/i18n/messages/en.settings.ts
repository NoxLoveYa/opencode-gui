...
export const settingsDict = {
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterial': 'Window material',
  'settings.openchamber.desktopNetwork.field.windowMaterialDescription': 'Let the Windows desktop backdrop show through the main window. Mica is subtle, Acrylic blurs more. Windows only.',
  'settings.openchamber.desktopNetwork.field.windowMaterialAria': 'Window material',
  'settings.openchamber.desktopNetwork.option.windowMaterialOff': 'Off',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacity': 'Backdrop opacity',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription': 'How solid the app background stays over the desktop backdrop. Lower lets more of it through.',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria': 'Backdrop opacity',
  ...
  'settings.openchamber.visual.field.widgetCorners': 'Widget shape',
  'settings.openchamber.visual.field.widgetCornersHint': 'Round keeps the current look. Square removes all corner rounding.',
  'settings.openchamber.visual.field.widgetCornersAria': 'Select widget shape',
  'settings.openchamber.visual.option.widgetCorners.round': 'Round',
  'settings.openchamber.visual.option.widgetCorners.square': 'Squared',
