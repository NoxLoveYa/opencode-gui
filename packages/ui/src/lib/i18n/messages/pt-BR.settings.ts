...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.desktopNetwork.field.windowMaterial": "Material da janela",
  "settings.openchamber.desktopNetwork.field.windowMaterialDescription": "Deixa o plano de fundo da área de trabalho do Windows aparecer através da janela principal. Mica é sutil, Acrílico desfoca mais. Somente Windows.",
  "settings.openchamber.desktopNetwork.field.windowMaterialAria": "Material da janela",
  "settings.openchamber.desktopNetwork.option.windowMaterialOff": "Desligado",
  "settings.openchamber.desktopNetwork.option.windowMaterialMica": "Mica",
  "settings.openchamber.desktopNetwork.option.windowMaterialAcrylic": "Acrílico",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacity": "Opacidade do plano de fundo",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription": "Quão sólido o fundo do app fica sobre o plano de fundo da área de trabalho. Menor deixa passar mais.",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria": "Opacidade do plano de fundo",
  ...
  "settings.openchamber.visual.field.widgetCorners": "Forma dos widgets",
  "settings.openchamber.visual.field.widgetCornersHint": "Arredondado mantém a aparência atual. Quadrado remove todos os cantos arredondados.",
  "settings.openchamber.visual.field.widgetCornersAria": "Selecionar forma dos widgets",
  "settings.openchamber.visual.option.widgetCorners.round": "Arredondado",
  "settings.openchamber.visual.option.widgetCorners.square": "Quadrado",
