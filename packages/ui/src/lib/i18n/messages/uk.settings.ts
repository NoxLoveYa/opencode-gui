...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.desktopNetwork.field.windowMaterial": "Матеріал вікна",
  "settings.openchamber.desktopNetwork.field.windowMaterialDescription": "Дозволяє тлу робочого столу Windows просвічувати крізь головне вікно. Mica стримана, Acrylic розмиває сильніше. Тільки Windows.",
  "settings.openchamber.desktopNetwork.field.windowMaterialAria": "Матеріал вікна",
  "settings.openchamber.desktopNetwork.option.windowMaterialOff": "Вимкнено",
  "settings.openchamber.desktopNetwork.option.windowMaterialMica": "Mica",
  "settings.openchamber.desktopNetwork.option.windowMaterialAcrylic": "Acrylic",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacity": "Непрозорість тла",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription": "Наскільки щільним лишається тло застосунку поверх тла робочого столу. Нижче значення пропускає більше.",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria": "Непрозорість тла",
  ...
  "settings.openchamber.visual.field.widgetCorners": "Форма віджетів",
  "settings.openchamber.visual.field.widgetCornersHint": "Заокруглена зберігає поточний вигляд. Квадратна прибирає всі заокруглення.",
  "settings.openchamber.visual.field.widgetCornersAria": "Вибрати форму віджетів",
  "settings.openchamber.visual.option.widgetCorners.round": "Заокруглена",
  "settings.openchamber.visual.option.widgetCorners.square": "Квадратна",
