...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterial': '窗口材质',
  'settings.openchamber.desktopNetwork.field.windowMaterialDescription': '让 Windows 桌面背景透过主窗口显示。Mica 较为含蓄，Acrylic 模糊更强。仅限 Windows。',
  'settings.openchamber.desktopNetwork.field.windowMaterialAria': '窗口材质',
  'settings.openchamber.desktopNetwork.option.windowMaterialOff': '关闭',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription': '应用背景在桌面背景之上保持多实。越低透得越多。',
  ...
  'settings.openchamber.visual.field.widgetCorners': '微件形状',
  'settings.openchamber.visual.field.widgetCornersHint': '圆角保持当前外观。方形移除所有圆角。',
  'settings.openchamber.visual.field.widgetCornersAria': '选择微件形状',
  'settings.openchamber.visual.option.widgetCorners.round': '圆角',
