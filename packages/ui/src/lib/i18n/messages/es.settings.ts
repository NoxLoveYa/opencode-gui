...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.desktopNetwork.field.windowMaterial": "Material de ventana",
  "settings.openchamber.desktopNetwork.field.windowMaterialDescription": "Deja que el fondo del escritorio de Windows se vea a través de la ventana principal. Mica es sutil, Acrílico difumina más. Solo Windows.",
  "settings.openchamber.desktopNetwork.field.windowMaterialAria": "Material de ventana",
  "settings.openchamber.desktopNetwork.option.windowMaterialOff": "Desactivado",
  ...
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacity": "Opacidad del fondo",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription": "Cuán sólido se mantiene el fondo de la app sobre el fondo del escritorio. Más bajo deja pasar más.",
  "settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria": "Opacidad del fondo",
  ...
  "settings.openchamber.visual.field.widgetCorners": "Forma de widgets",
  "settings.openchamber.visual.field.widgetCornersHint": "Redondeado mantiene el aspecto actual. Cuadrado elimina todos los bordes redondeados.",
  "settings.openchamber.visual.field.widgetCornersAria": "Seleccionar forma de widgets",
  "settings.openchamber.visual.option.widgetCorners.round": "Redondeado",
  "settings.openchamber.visual.option.widgetCorners.square": "Cuadrado",
