...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterial': '창 재질',
  'settings.openchamber.desktopNetwork.field.windowMaterialDescription': 'Windows 바탕화면 배경이 기본 창을 통해 비치도록 합니다. Mica는 은은하고 Acrylic은 흐림이 강합니다. Windows 전용.',
  'settings.openchamber.desktopNetwork.field.windowMaterialAria': '창 재질',
  'settings.openchamber.desktopNetwork.option.windowMaterialOff': '끔',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacity': '배경 불투명도',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription': '바탕화면 배경 위에서 앱 배경을 얼마나 진하게 유지할지 정합니다. 낮을수록 더 많이 비칩니다.',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria': '배경 불투명도',
  ...
  'settings.openchamber.visual.field.widgetCorners': '위젯 모양',
  'settings.openchamber.visual.field.widgetCornersHint': '둥글게는 지금 모양 그대로. 각지게는 모든 둥근 모서리를 없앱니다.',
  'settings.openchamber.visual.field.widgetCornersAria': '위젯 모양 선택',
  'settings.openchamber.visual.option.widgetCorners.round': '둥글게',
  'settings.openchamber.visual.option.widgetCorners.square': '각지게',
