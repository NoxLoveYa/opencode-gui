...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterial': '視窗材質',
  'settings.openchamber.desktopNetwork.field.windowMaterialDescription': '讓 Windows 桌面背景透過主視窗顯示。Mica 較含蓄，Acrylic 模糊更強。僅限 Windows。',
  'settings.openchamber.desktopNetwork.field.windowMaterialAria': '視窗材質',
  'settings.openchamber.desktopNetwork.option.windowMaterialOff': '關閉',
  ...
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacity': '背景不透明度',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityDescription': '應用程式背景在桌面背景之上保持多實。越低透得越多。',
  'settings.openchamber.desktopNetwork.field.windowMaterialOpacityAria': '背景不透明度',
  ...
  'settings.openchamber.visual.field.widgetCorners': '小工具形狀',
  'settings.openchamber.visual.field.widgetCornersHint': '圓角保持目前外觀。方形移除所有圓角。',
  'settings.openchamber.visual.field.widgetCornersAria': '選擇小工具形狀',
  'settings.openchamber.visual.option.widgetCorners.round': '圓角',
  'settings.openchamber.visual.option.widgetCorners.square': '方形',
